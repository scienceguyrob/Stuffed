...
public class Example 
{
	...
	{
		// Input variables.
		String outputPath  = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/Test_One.txt";
		String predictPath = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/TestOne_Predict.arff";
		String trainingSet = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/MiniBoone.arff";
		String testSet     = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/MiniBoone.arff"; // Use same data just for these examples!
	...
	{
		// Input variables.
		String outputPath  = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/Test_Two.txt";
		String predictPath = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/TestTwo_Predict.arff";
		String trainingSet = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/MiniBoone.arff";
		String testSet     = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/MiniBoone.arff";
		boolean verbose    = true;
		boolean recordMissclassifications = true;
	...
	{
		// Input variables.
		String outputPath   = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/Test_Three.txt";
		String dataPath     = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/MiniBoone.arff";

		// Destination training and test files.
		String testSetPath  = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/test.arff";
		String trainSetPath = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/train.arff";
		...
		double trainSetBalance = posTrainSamples/negTrainSamples;  // Equal training set balance.
	...
	/**
	 * Tests the sampling procedure on another data set.
	 */
	private static void testFour()
	{
		...
		// Input variables.
		String outputPath   = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/test/Test_Three.txt";
		String dataPath     = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/SPINN/SPINN.arff";

		// Destination training and test files.
		String testSetPath  = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/SPINN/test.arff";
		String trainSetPath = "/home/rob/git/scienceguyrob/Stuffed/Stuffed/data/SPINN/train.arff";
		...
		// Sampling variables:
		int pos = 1196;  // Positives in the data file.
		int neg = 89996; // Negatives in the data file.

		// The desired training set distribution - minimum of one example per class.
		// This can be changed in the code if you prefer.
		int negTrainSamples = 1000;
		int posTrainSamples = 100;

		// Desired training set balance.
		double trainSetBalance = (double)posTrainSamples/(double)negTrainSamples;  // Equal training set balance.

		// The proportion of the test set we would like labelled.
		double labelling       = 1.0; // 10% of test data labelled.
		double testSetBalance  = ((double)pos - (double)posTrainSamples) / ((double)neg - (double)negTrainSamples);

		// Build sampler.
		Sampler s = new Sampler(outputPath,verbose);
		s.load(dataPath, -1); // Read in the file to be sampled.
