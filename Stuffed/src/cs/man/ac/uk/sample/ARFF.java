...
/**
 * The class ARFF represents a WEKA ARFF file that can be sampled.
 *
 * @author Rob Lyon
 *
 * @version 1.0, 05/30/14
 */
public class ARFF extends BaseFile
{
	//*****************************************
	//*****************************************
	//              Variables
	 ...
	 */
	public ARFF(String path,int classIndex,String logPath, boolean v)
	{
		super(path, classIndex, logPath,v);
		editor = new ARFFEditor(this);
	}
	...
	public boolean preprocess()
	{
		...
		{
			log("ARFF editor did not complete preprocessing.");
			return false;
		}
	}
